...
$url = RANDAVERIFY_BASE_URL . "/verify-nin/slip/premium/" . urlencode($transaction_id);
...
if ($http_code === 200 && strpos($content_type, 'application/pdf') !== false) {
    ...
    header('Content-Disposition: attachment; filename="Premium_Slip_' . $transaction_id . '.pdf"');
